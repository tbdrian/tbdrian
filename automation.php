...
class Automation {
    ...
    private $bountyOpop = 1;
        ...
        global $session;
        switch($ref) {
            case 1: $build = "Kilang Kayu"; break;
            case 2: $build = "Kilang Bata"; break;
            case 3: $build = "Lombong Besi"; break;
            case 4: $build = "Ladang Gandum"; break;
            case 5: $build = "Pembalak"; break;
            case 6: $build = "Bata"; break;
            case 7: $build = "Besi"; break;
            case 8: $build = "Kilang"; break;
            case 9: $build = "Kedai Roti"; break;
            case 10: $build = "Cache"; break;
            case 11: $build = "Gudang Gandum"; break;
            case 12: $build = "Kilang Logam"; break;
            case 14: $build = "Padang Latihan"; break;
            case 15: $build = "Bangunan Utama"; break;
            case 16: $build = "Kem"; break;
            case 17: $build = "Pasar"; break;
            case 18: $build = "Kedutaan"; break;
            case 19: $build = "Berek"; break;
            case 20: $build = "Gerai"; break;
            case 21: $build = "Bengkel"; break;
            case 22: $build = "Akademi"; break;
            case 23: $build = "cache"; break;
            case 24: $build = "Forumر"; break;
            case 25: $build = "Domisil"; break;
            case 26: $build = "Istana"; break;
            case 27: $build = "Bank"; break;
            case 28: $build = "Rumah Perdagangan"; break;
            case 29: $build = "Kem Besar"; break;
            case 30: $build = "Kandang Kuda Besar"; break;
            case 31: $build = "Dinding"; break;
            case 32: $build = "Dinding Bumi"; break;
            case 33: $build = "Perlindungan"; break;
            case 34: $build = "Rumah Agam"; break;
            case 35: $build = "Kilang Bir"; break;
            case 36: $build = "Tele Membuat"; break;
            case 37: $build = "Rumah Pahlawan"; break;
            case 38: $build = "Bangsal Besar"; break;
            case 39: $build = "Jelapang Besar"; break;
            case 40: $build = "Keajaiban Dunia"; break;
            case 41: $build = "Kemudahan Kuda"; break;
            case 42: $build = "Bengkel"; break;
            default: $build = "Ralat"; break;
        }
        return $build;
    }
