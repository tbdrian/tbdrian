...
//ERRORS
define("USRNM_EMPTY","(Sila masukkan nama samaran anda)");
define("USRNM_TAKEN","(Nama samaran ini telah digunakan)");
define("USRNM_SHORT","(Sekurang-kurangnya ".USRNM_MIN_LENGTH." aksara diperlukan)");
define("USRNM_CHAR","(Terdapat aksara yang tidak sah)");
define("PW_EMPTY","(Sila masukkan kata laluan anda)");
define("PW_SHORT","(Sekurang-kurangnya ".PW_MIN_LENGTH." aksara diperlukan)");
define("PW_INSECURE","(Kata laluan tidak sah. Sila pastikan kata laluan anda selamat)");
define("EMAIL_EMPTY","(Sila masukkan email anda)");
define("EMAIL_INVALID","(Emel tidak sah)");
define("EMAIL_NOTEXIST","Emel ini tidak wujud.");
define("EMAIL_TAKEN","(Emel ini telah digunakanه)");
define("TRIBE_EMPTY","<li>Sila pilih puak anda</li>");
define("AGREE_ERROR","<li>Sila baca dan sahkan peraturan permainan</li>");
define("LOGIN_USR_EMPTY","Sila masukkan nama samaran anda");
define("LOGIN_PASS_EMPTY","Sila masukkan kata laluan anda");
define("EMAIL_ERROR","Emel yang dimasukkan tidak sah");
define("PASS_MISMATCH","Kata laluan tidak sepadan");
define("ALLI_OWNER","Sila pilih pengganti anda sebelum keluar dari persekutuan");
define("SIT_ERROR","این جانشین قبلا انتخاب شده");
define("USR_NT_FOUND","Nama samaran tidak wujud");
define("USR_BAN","Akaun ini telah disekat");
define("LOGIN_PW_ERROR","Kata laluan tidak sah");
define("WEL_TOPIC","Penerangan dan data ");
...
//WARSIM.TPL
define("WARSIM","Simulasi peperangan");
define("WARSIM_ATTACKER","Penyerang");
define("WARSIM_DEFENDER","Pertahanan");
define("WARSIM_ETC","Lain-lain");

define("WARSIM_POP","Populasi");
define("WARSIM_KATA","Sasaran tarbil");
define("WARSIM_HEROPOWER","Hero (Bonus serangan)");
define("WARSIM_STONEMASON","Tukang batu");
define("WARSIM_PALACE","Istana / Residen");

//BUILDINGS
define("B1","Kawasan pembalakan");
define("B1_DESC","Kayu dihasilkan disini. Dengan meningkatkan tahapnya, anda meningkatkan produksi kayu.");
define("B2","Kuari tanah liat");
define("B2_DESC","Tanah liat dihasilkan di sini. Dengan meningkatkan tahapnya, anda meningkatkan produksi tanah liat.");
define("B3","Lombong bijih besi");
define("B3_DESC","Bijih besi dihasilkan di sini. Dengan meningkatkan tahapnya, anda meningkatkan produksi besi.");
define("B4","Ladang");
define("B4_DESC","Makanan populasi anda dihasilkan di sini. Dengan meningkatkan tahap ladang, anda meningkatkan produksi tanaman.");
...
define("SEVER_TIME","Masa pelayan:");
define("SIDEINFO_CHANGEVIL_BTN","Simpan"); 
define("SIDEINFO_CHANGEVIL_LABEL","Nama baru kampung:"); 
define("SIDEINFO_CHANGEVIL_TITLE","Tukar nama kampung."); 
define("SIDEINFO_CHANGE_TITLE","Klik dua kali disini untuk menukar nama kampung anda."); 
define("SIDEINFO_ADVENTURES","Pengembaraan"); 
define("SIDEINFO_AUCTIONS","Lelongan"); 
define("SIDEINFO_PROFILE","Profail");
define("SIDEINFO_ALLIANCE","Persekutuan");
define("SIDEINFO_ALLY_FORUM","Forum persekutuan");
...
//INDEX.php
define("LOGIN","Log-Masuk");
define("PLAYERS","Pemain");
define("ONLINE","Dalam talian");
define("TUTORIAL","Jelajah permainan");
define("PLAYER_STATISTICS","Statistik pemain");
define("TOTAL_PLAYERS","Jumlah ".PLAYERS."");
define("ACTIVE_PLAYERS","Pemain aktif");
define("ONLINE_PLAYERS","".PLAYERS." dalam talian");
define("MP_STRATEGY_GAME","".SERVER_NAME." - Permainan peluncur - Rom, Gaul, dan Teuton");
...
define("REGISTER_FOR_FREE","Daftar disini dengan percuma!");
define("LATEST_GAME_WORLD","Pelayan terbaru!");
define("LATEST_GAME_WORLD2","Mendaftar ke pelayan baru<br/>dan dapatkan kelebihan sebagai<br />antara yang terawal.");
define("PLAY_NOW","Main Travian sekarang di ".SERVER_NAME."");
define("LEARN_MORE","Ketahui lebih lanjut <br/>berkenaan ".SERVER_NAME."!");
define("COMUNITY","Komuniti");
define("NEWS","Berita");
define("SCREENSHOTS","Tangkapan skrin");
define("LOGIN_TO","Log-masuk ke ". SERVER_NAME);
define("REGIN_TO","Daftar di ". SERVER_NAME);
define("P_ONLINE","Pemain dalam talian: ");
define("P_TOTAL","Jumlah pemain: ");
define("CHOOSE","Sila pilih pelayan");
define("STARTED"," Pelayan bermula ". round((time()-COMMENCE)/86400) ." hari yang lalu.");
