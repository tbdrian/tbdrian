...
//WARSIM.TPL edit ~ ujang
define ("WARSIM", "perang simulator");
define ("WARSIM_ATTACKER", "penyerang");
define ("WARSIM_DEFENDER", "pertahanan");
define ("WARSIM_ETC", "lain");

define("WARSIM_POP", "orang ramai");
define("WARSIM_KATA", "sasaran Tarbil");
define("WARSIM_HEROPOWER", "Hero (Score Attack)");
define("WARSIM_STONEMASON", "batu");
define("WARSIM_PALACE", "istana / rumah");

define("B1", "Kawasan Pembalakan");
define("B1_DESC", ". Pengeluaran kayu pembalakan ini perlu lagi dinaik taraf untuk menghasilkan kayu yang banyak");
define("B2", "Kawasan Tanah Liat");
define("B2_DESC", " Pengeluaran Tanah Liat ini perlu lagi dinaik taraf untuk menghasilkan Tanah Liat yang banyak");
define("B3", "Lombong Bijih Besi");
define("B3_DESC", "Pengeluaran Bijih Besi ini perlu lagi dinaik taraf untuk menghasilkan Besi yang banyak");
define("B4", "bidang gandum");
define("B4_DESC", "makanan di sini akan menghasilkan hasil yang lebih tinggi daripada kawasan yang Melrose");
...
define("REPORT_FROM_ALLY","Ally / Clans");
define("REPORT_SENT","Dihantar");
define("REPORT_SENDER","Penghantar");
define("REPORT_RECEIVER","Penerima");
define("REPORT_AT","Pada");
define("REPORT_TO","Untuk");
define("REPORT_SEND_RES","Menghantar Sumber");
define("REPORT_DEL_BTN","Padam Report");
define("REPORT_DEL_QST","Setuju?");
define("REPORT_WARSIM","Berperang");
define("REPORT_ATK_AGAIN","Serangan Berterusan");
define("REPORT_TROOPS","Tentera");
define("REPORT_REINF","Penambahan Kekuatan");
define("REPORT_CASUALTIES","Kerugian");
define("REPORT_INFORMATION","Maklumat");
define("REPORT_BOUNTY","Ganjaran");
define("REPORT_CLOCK","Masa");
define("REPORT_UPKEEP","Makanan");
define("REPORT_PER_HOURS","H");
define("REPORT_SEND_REINF_TO","Penambahan Kekuatan dihantar kepada");

//MASSMESSAGE.php edit ~ujang
define("MASS","mesej teks");
define("MASS_SUBJECT","Subject:");
define("MASS_COLOR","Warna:");
define("MASS_REQUIRED","Semua Ruang");
...
define("MASS_ABORT", "Tidak dapat menghantar");
