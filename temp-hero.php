...
<div id="attributes"><div class="boxes boxesColor gray"><div class="boxes-tl"></div><div class="boxes-tr"></div><div class="boxes-tc"></div><div class="boxes-ml"></div><div class="boxes-mr"></div><div class="boxes-mc"></div><div class="boxes-bl"></div><div class="boxes-br"></div><div class="boxes-bc"></div><div class="boxes-contents">
    	<div class="attribute headline">
			<div class="attributesHeadline">spesifikasi</div>
			<div class="pointsHeadline">point</div>
			<div class="clear"></div>
		</div>
		<div class="clear"></div>
  <div class="attribute power tooltip" title="Power attack | | power, attack power and defense is a combination of offensive hero. However, the more offensive power is much less traumatic to the size of your adventures will.<br><font color='#5dcbfb'>Inrush power: <?php echo $hero['power']; ?> Juara</font>">
			<div class="element attribName">Inrush power</div>
		...
		<div class="clear"></div>
  <div class="attribute offBonus tooltip" title="Score attack | | will increase attacking power with all will be champions.<br><font color='#5dcbfb'>mata serangan: <?php echo ($hero['offBonus']/200); ?>%</font>">
			<div class="element attribName">mata serangan</div>
  ...
  <div class="attribute defBonus tooltip" title="Rating Defense | | increases the defense with all will be champions.<br><font color='#5dcbfb'>Kedudukan Pertahanan: <?php echo ($hero['defBonus']/200); ?>%</font>">
			<div class="element attribName">Kedudukan Pertahanan</div>
  ...
  <div class="attribute productionPoints tooltip" title="Resources | | village resources that will increase production of its hero currently resides.
<br><font color='#5dcbfb'>Meningkatkan pengeluaran sumber: <?php echo intval($hero['product']); ?> sumber</font>">
			<div class="element attribName">sumber</div>
    ...
    <div class="attribute res" id="setResource">
		<div class="changeResourcesHeadline">تغییر نوع تولید sumber از طرف قهرمان</div>
		<div class="clear"></div>
		<div class="resource">
		  <input type="radio" onclick="window.location.href = '?product=r0';" name="resource" value="0" id="resourceHero0" <?php if($hero['r0']!=0){ echo $checked="checked"; } ?>>
			<label for="resourceHero0">
				<img title="تمامی sumber" class="r0" src="img/x.gif">
...
if(!$checkT){
    if($village->awood < $tt2[$hero['level']]['wood'] || $village->aclay < $tt2[$hero['level']]['clay'] || $village->airon < $tt2[$hero['level']]['iron'] || $village->acrop < $tt2[$hero['level']]['crop']){
    	echo '<span class="none">sumber کافی برای زنده کردن قهرمان ندارد.</span>';
    }else{
